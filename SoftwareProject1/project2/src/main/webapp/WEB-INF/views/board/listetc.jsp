	...
	<div class="container">
		...
		<section class="content">
			...
			<table width="800px"
				...
				<th colspan="4"
					style="height: 40px; vertical-align: top; text-align: left;">etc.</th>
